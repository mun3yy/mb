        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {!showFullBrowser ? (
            <motion.div
              ...
              className="max-w-2xl mx-auto bg-black/50 backdrop-blur-sm p-6 rounded-lg border border-white/10 mb-8"
            >
              <div className="flex flex-col items-center justify-center space-y-6">
                ...
                <p className="text-gray-400 text-center">
                  Our embedded browser lets you browse any website without leaving this page. GoGuardian won't detect
                  your searches because they're routed through our secure proxy.
                </p>
